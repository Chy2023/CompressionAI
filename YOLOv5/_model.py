...
class Choi2022(Cheng2020Anchor):
    ...
    '''
    def __init__(self,N=192,groups=[128,64],r=[2,1,1,1],M=128,**kwargs):
    ...
    def forward(self,x):
        ...
        feature_target=self.yolo.forward(x,cut_model=1)
        feature=self.LST(y_hat[0])
        feature=self.yolo.BN_Act(feature)
    ...
    def yolov5(self,weights='yolov5s.pt',cfg='models/yolov5s.yaml'):
